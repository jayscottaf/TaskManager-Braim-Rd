...
export const FEATURE_TEMPLATES: FeatureTemplate[] = [
  {
    ...
    popularity: 1247,
    schema: [
      { name: "Brand", type: "text", placeholder: "e.g., Benjamin Moore" },
      { name: "Color Name", type: "text", placeholder: "e.g., Simply White" },
      { name: "Color Code", type: "text", placeholder: "e.g., OC-117" },
